      ...
      <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-6 py-20 text-center">
          ...
          <div className="mt-12 flex flex-col sm:flex-row items-center justify-center gap-6 flex-wrap">
            <Link 
              href="https://github.com/keiz7en/LimeSugar/releases/download/v0.2.2/LimeSugar-v0.2.2-universal.apk"
            ...
            <Link 
              href="https://github.com/keiz7en/LimeSugar/releases/tag/v0.2.2"
          ...
          <div className="mt-6 flex flex-wrap items-center justify-center gap-3">
            {[
               { n: "universal", s: "69 MB", h: "https://github.com/keiz7en/LimeSugar/releases/download/v0.2.2/LimeSugar-v0.2.2-universal.apk" },
               { n: "arm64-v8a", s: "69 MB", h: "https://github.com/keiz7en/LimeSugar/releases/download/v0.2.2/LimeSugar-v0.2.2-arm64-v8a.apk" },
               { n: "armeabi-v7a", s: "69 MB", h: "https://github.com/keiz7en/LimeSugar/releases/download/v0.2.2/LimeSugar-v0.2.2-armeabi-v7a.apk" },
               { n: "x86_64 · emulator", s: "69 MB", h: "https://github.com/keiz7en/LimeSugar/releases/download/v0.2.2/LimeSugar-v0.2.2-x86_64.apk" },
               { n: "Windows", s: "Soon", h: "https://github.com/keiz7en/LimeSugar/releases/tag/v0.2.2" },
             ].map((v, i) => (
          ...
          <div className="mt-10 inline-flex items-center gap-3 px-4 py-2 glass rounded-lg">
            <span className="text-sm text-text-dim">Latest Release</span>
              <span className="px-3 py-1 text-sm font-semibold gold-gradient-text">v0.2.2</span>
