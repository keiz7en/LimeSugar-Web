      ...
      <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-6 py-20 text-center">
          ...
          <div className="mt-12 flex flex-col sm:flex-row items-center justify-center gap-6 flex-wrap">
            <Link 
              href="https://github.com/keiz7en/LimeSugar/releases/download/v0.1.3-beta/LimeSugar-v0.1.3-beta-universal.apk"
            ...
            <Link 
              href="https://github.com/keiz7en/LimeSugar/releases/tag/v0.1.3-beta"
          ...
          <div className="mt-6 flex flex-wrap items-center justify-center gap-3">
            {[
               { n: "universal", s: "69 MB", h: "https://github.com/keiz7en/LimeSugar/releases/download/v0.1.3-beta/LimeSugar-v0.1.3-beta-universal.apk" },
          ...
          <div className="mt-10 inline-flex items-center gap-3 px-4 py-2 glass rounded-lg">
            <span className="text-sm text-text-dim">Latest Release</span>
              <span className="px-3 py-1 text-sm font-semibold gold-gradient-text">v0.1.3-beta</span>
