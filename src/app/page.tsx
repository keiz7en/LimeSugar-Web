      ...
      <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-6 py-20 text-center">
          ...
          <div className="mt-12 flex flex-col sm:flex-row items-center justify-center gap-6 flex-wrap">
            <Link 
              href="https://github.com/keiz7en/LimeSugar/releases/download/v0.2.4-build-3/app-release.apk"
            ...
            >
              ...
              <span className="text-sm opacity-80">68.0 MB · APK</span>
            </Link>
            
            <Link 
              href="https://github.com/keiz7en/LimeSugar/releases/tag/v0.2.4-build-3"
          ...
          <div className="mt-6 flex flex-wrap items-center justify-center gap-3">
            {[
               { n: "universal", s: "68.0 MB", h: "https://github.com/keiz7en/LimeSugar/releases/download/v0.2.4-build-3/app-release.apk" },
               { n: "arm64-v8a", s: "68.0 MB", h: "https://github.com/keiz7en/LimeSugar/releases/download/v0.2.4-build-3/app-release.apk" },
               { n: "armeabi-v7a", s: "68.0 MB", h: "https://github.com/keiz7en/LimeSugar/releases/download/v0.2.4-build-3/app-release.apk" },
               { n: "x86_64 · emulator", s: "68.0 MB", h: "https://github.com/keiz7en/LimeSugar/releases/download/v0.2.4-build-3/app-release.apk" },
               { n: "Windows", s: "33.8 MB", h: "https://github.com/keiz7en/LimeSugar/releases/tag/v0.2.4-build-3" },
             ].map((v, i) => (
          ...
          <div className="mt-10 inline-flex items-center gap-3 px-4 py-2 glass rounded-lg">
            <span className="text-sm text-text-dim">Latest Release</span>
               <span className="px-3 py-1 text-sm font-semibold gold-gradient-text">v0.2.4-build-3</span>
